...
| ------- | ------- | ---------- | ------------------- |
|         |         | 2025-11-19 | Clearing tables (verifiers, presentations, but not identifiers and keys) if `BEARER_TOKEN` is empty, enforcing file based configuration on restart of the application |
